...
Pour réaliser une application de qualité il faut un plan; une méthodologie. La première étape de cette méthodologie  est l'analyse  qui nous permettra de répertorier les fonctionnalités principales de l'application, tandis que l'étape de conception nous permettra de modéliser les solutions suite à l'analyse en ayant recours au langage de modélisation choisi. La troisième étape consiste en la réalisation et en l'implémentation de l'application. Ce mémoire sera divisé en trois chapitres:
