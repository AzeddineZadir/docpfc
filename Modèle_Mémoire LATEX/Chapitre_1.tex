...
Les smartphones ont révolutionné le monde de par le nombre de fonctionnalités et de possibilités qu'ils offrent. Il est de nos jours quasi-indispensable d'en posséder. Plus de 50\% de la population mondiale possède déjà un smartphone et les étudiants en présentent la majeure partie \cite{2}.
...
\begin{figure}[h!]
	...
	\caption{Les différents types d'applications mobiles \cite{5}.}
